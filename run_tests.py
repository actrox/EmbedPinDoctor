...
def main():
    source_dirs = ["app", "core", "export", "integrations", "versioning", "plugins", "collaboration", "quality", "release", "backup", "diagnostics", "utils", "tests"]
    ...
    print(f"P6 regression passed: compiled={len(sources)} tests={len(tests)}")
