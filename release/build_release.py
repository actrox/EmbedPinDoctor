...
def build_release():
    ...
    folders = ["app", "core", "data", "ecosystem", "export", "integrations", "versioning", "plugins", "collaboration", "quality", "release", "backup", "diagnostics", "utils", "web", "docs", "examples", "rule_packs"]
    for folder in folders:
        src = ROOT / folder
        if src.exists():
            shutil.copytree(src, target / folder, ignore=shutil.ignore_patterns("__pycache__", "*.pyc", "*.pyo"))
    ...
    manifest = {"name": "EmbedPinDoctor", "version": version, "entry": "launcher.py", "project_schema": 2}
